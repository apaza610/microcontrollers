...
FINAL_IMAGE=${DISTDIR}/Puertos.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Puertos.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC12F675
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Puertos.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
